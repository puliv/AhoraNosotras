    ...
    return (
      <div className="learning">
        <div className="learning-text">
          <h2 className="learning-h2-title">APRENDEMOS</h2>
          <span className="learning-span intro">
            #AhoraNosotras es un también un encuentro, un intercambio, en el que
            juntas aprendemos y desarrollamos todas nuestras habilidades e
            intereses. Aquí podrás encontrar todos los materiales formativos de
            nuestra Escuela Nacional y las charlas virtuales que estamos
            desarrollando.
          </span>
        </div>
          ...
          <div className="learning-video-div a">
            ...
            <div className="learning-video-text">
              ...
              <span className="learning-span-video">
                ...
                efectuó una charla sobre el Ingreso de Emergencia, política
                pública con perspectiva de género que tiene por propósito
                beneficiar 3,6 millones de hogares argentinos. Esto con el
                objetivo de abrir la discusión sobre Renta Básica de Emergencia
                en Chile.
              </span>
            </div>
          </div>
          ...
          <div className="learning-video-div b">
            ...
            <div className="learning-video-text">
              ...
              <span className="learning-span-video">
                ...
                género puede ser un eje fundante y transversal que irradie la
                discusión constitucional en la futura Convención Constitucional,
                descartando una visión neutra respecto de la forma y contenido
        ...
        <div className="learning-div-pdf">
          ...
          <span className="learning-span pdf-span">
            Si quieres profundizar en los contenidos de nuestras Escuelas y
            Charlas Virtuales. <br />
            Revisa los materiales preparados por las y los profesores y ponentes
            de #AhoraNosotras.
          </span>
          <div className="learning-pdf">
            <div className="learning-pdf-div-icon">
              <img src={pdf_icon_1} alt="pdf_icon" className="pdf-icon" />
            </div>
            <div className="learning-pdf-div-text">
              <h3 className="learning-h3">Comunicación estratégica</h3>
              <a
                className="learning-pdf-a"
                href={COMUNICACION_ESTRATEGICA}
                target="/blank"
              >
                [PDF] Comunicación estratégica y construcción del discurso
                político
              </a>
              <p className="learning-pdf-author">
                Por Juanita Rojas, Auska Ovando y Camila Rodriguez, diciembre
                2019.
              </p>
              <a
                className="learning-pdf-a"
                href={RECOMENDACIONES_PARA_ESTRATEGIA_COMUNICACIONAL}
                target="/blank"
              >
                [PDF] Recomendaciones para construir una estrategia
                comunicacional
              </a>
              <p className="learning-pdf-author">
                Por Juanita Rojas, Auska Ovando y Camila Rodriguez, diciembre
              ...
              <a
                className="learning-pdf-a"
                href={COMUNICACIÓN_POLÍTICA}
                target="/blank"
              >
                [PDF] Comunicación política
              </a>
              <p className="learning-pdf-author">Por Sebastian Kraljevich.</p>
            </div>
          </div>

          <div className="learning-pdf">
            <div className="learning-pdf-div-icon">
              <img src={pdf_icon_2} alt="pdf_icon" className="pdf-icon" />
            </div>
            <div className="learning-pdf-div-text">
              <h3 className="learning-h3">Historia Feminista</h3>
              <a
                className="learning-pdf-a"
                href={FEMINISMOS_TENSIONES_Y_FORMAS}
                target="/blank"
              >
                [PDF] Feminismos, tensiones y formas de participación política
              </a>
              <p className="learning-pdf-author">
              ...
              <a
                className="learning-pdf-a"
                href={VIOLENCIA_DE_GÉNERO_Y_FEMINISMOS}
                target="/blank"
              >
                [PDF] Violencia de género y feminismos en Chile, 1970 - Presente
              </a>
              <p className="learning-pdf-author">
          ...
          <div className="learning-pdf">
            <div className="learning-pdf-div-icon">
              <img src={pdf_icon_3} alt="pdf_icon" className="pdf-icon" />
            </div>
            <div className="learning-pdf-div-text">
              <h3 className="learning-h3">Proceso Constituyente</h3>
              <a
                className="learning-pdf-a"
                href={HERRAMIENTAS_PARA_LA_COMPRENSION}
                target="/blank"
              >
                [PDF] Herramientas para la comprensión sobre el acuerdo por una
                nueva constitución
              </a>
              <p className="learning-pdf-author">
              ...
              <a
                className="learning-pdf-a"
                href={PODER_FEMINISTA_CONSTITUYENTE}
                target="/blank"
              >
                [PDF] Poder feminista constituyente
              </a>
              <p className="learning-pdf-author">
              ...
              <a
                className="learning-pdf-a"
                href={PROCESOS_CONSTITUYENTES_CONSTITUCIONES}
                target="/blank"
              >
                [PDF] Procesos constituyentes y constituciones: una lectura de
                género
              </a>
              <p className="learning-pdf-author">
              ...
              <a
                className="learning-pdf-a"
                href={FEMINISMO_Y_ASAMBLEA_CONSTITUYENTE}
                target="/blank"
              >
                [PDF] Feminismo y Asamblea Constituyente
              </a>
              <p className="learning-pdf-author">Por Unidad de Género, 2016.</p>
            </div>
          </div>

          <div className="learning-pdf">
            <div className="learning-pdf-div-icon">
              <img src={pdf_icon_4} alt="pdf_icon" className="pdf-icon" />
            </div>
            <div className="learning-pdf-div-text">
              <h3 className="learning-h3">Otras Experiencias</h3>
              <a
                className="learning-pdf-a"
                href={Ingreso_familiar_de_emergencia_1}
                target="/blank"
              >
                [PDF] Ingreso familiar de emergencia
              </a>
              <p className="learning-pdf-author">
        ...
        <div className="learning-div-image">
          <img src={MUJERES} alt="MUJERES" className="learning-img-women" />
        </div>
      </div>
    );
  }
